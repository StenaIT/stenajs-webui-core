...
import {cardContentStyle, cardTitleStyle, cardWrapperExpandedStyle, cardWrapperStyle} from './CardStyle';
...
export const Card: React.StatelessComponent<CardProps> = ({
    ...
    return(
        <div className={`${cardWrapperStyle} ${(isExpanded) ? cardWrapperExpandedStyle : null}`}>
            <Spacing>
                <Shadow>
                    <Border borderRadius={attr.borderRadius} style={{overflow:"hidden"}}>
                        <div className={`${cardContentStyle} ${attr.className}`}>
                            ...
                            <Border bottom={true}>
                                <Row width="100%" alignItems="flex-end" justifyContent="space-between">
                                    <Column minWidth="300px" alignSelf="flex-start" flexGrow={1}>
                                        ...
                                        <Row>
                                            ...
                                            {(attr.hasButton) && (
                                                <Column className="CardBtn">
                                                    <Spacing>
                                                        <StandardButton onClick={onClick} label={(isExpanded) ? attr.btnLabelExpanded : attr.btnLabelDefault} />
                                                    </Spacing>
                                                </Column>
                                            )}
                                            <Space />
