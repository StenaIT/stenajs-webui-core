...
import {drawerContentStyle, drawerOpenWrapperStyle, drawerWrapperStyle} from "./DrawerStyle";
...
export const Drawer: React.StatelessComponent<IDrawerProps> = ({
   isOpen, onClick, children, buttonLabel, buttonIcon, headerColor, marginTop
}) => (
    <div className={`DrawerWrapper ${drawerWrapperStyle} ${(isOpen) && `${drawerOpenWrapperStyle} Drawer--open`}`} style={(marginTop) ? {top:marginTop, paddingBottom:marginTop} : {top:0, paddingBottom:0}}>
